...
//    3) Expected behavior: When you spin the Merry Go round system will print out "Merry Go Round triggered" to the serial monitor.
//                         The system will also print which note/cc value it should be sending to Ableton.
//                         It will also print out the RAW sensor information, which is useful when tracking down bad switches.

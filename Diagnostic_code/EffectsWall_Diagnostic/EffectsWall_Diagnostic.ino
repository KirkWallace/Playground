//Effects Wall Diagnostic code
// Directions for use:
//    1) Flash with board type: Arduino Leonardo
//    2) open the Serial monitor to see the output of the sensors, baud (115200)
//    3) Expected behavior: When you spin a nob the MIDI viewer will display the changing MIDI data
